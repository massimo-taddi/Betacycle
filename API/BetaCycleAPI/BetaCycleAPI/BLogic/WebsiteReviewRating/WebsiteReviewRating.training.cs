...
namespace BetaCycleAPI
{
    public partial class WebsiteReviewRating
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"overall",inputColumnName:@"overall",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"overall", sentence1ColumnName: @"reviewText"))      
