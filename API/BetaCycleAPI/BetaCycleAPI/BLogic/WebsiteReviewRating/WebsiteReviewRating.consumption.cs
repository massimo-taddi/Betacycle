...
namespace BetaCycleAPI
{
    ...
    {
        /// <summary>
        /// model input class for WebsiteReviewRating.
        /// </summary>
        ...
        /// <summary>
        /// model output class for WebsiteReviewRating.
        /// </summary>
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("overall");
            if (labelColumn == null)
            {
                throw new Exception("overall column not found. Make sure the name searched for matches the name in the schema.");
            }
